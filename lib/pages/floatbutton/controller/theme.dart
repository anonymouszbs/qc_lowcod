...
final karasubo = ReaderTheme(
    ...
    readerTextColor: const Color.fromARGB(255, 255, 255, 255),
    readerInfoColor: const Color(0xff7e7e7e),
    pannelBackgroundColor: const Color(0xff17191a),
    pannelTextColor: const Color.fromARGB(255, 255, 255, 255),
    primaryColor: const Color.fromARGB(255, 25, 173, 159),
    dividerColor: const Color.fromARGB(255, 249, 246, 246),
...
class ReaderThemeC extends GetxController{
  ...
  Rx<SpeedDialDirection> floatbuttonDirection = SpeedDialDirection.right.obs;
